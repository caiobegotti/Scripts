...
in your iPodÕs Notes folder hierarchy, only the first 1,000 will be loaded. 
 - The size of any single note is truncated to 4,096 bytes of text (about 1,000 words). 
 - Up to 64 kilobytes of note text is cached. If the text of a note is in the cache, the iPod doesnÕt need 
