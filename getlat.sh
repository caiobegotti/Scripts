...
function getlat() { lynx -source --nolist http://en.wiktionary.org/wiki/${@//[[:space:]]/_} | sed '/<h2>.*Latin/,/<h2>/!d;/<h2>/d' | lynx -assume-charset=UTF-8 -stdin -dump --nolist | sed 's/\[edit\] //;s/_//g;/Retrieved/,//d'; }
